const fetchStudentDashboardData = () => {
    ...
    fetch('https://hstu-six.vercel.app/api/student/dashboard/', {
        method: 'GET',
        headers: {
...
const deleteBlog = (blogId) => {
    ...
    if (confirm('Are you sure you want to delete this blog?')) {
        fetch(`https://hstu-six.vercel.app/api/blog/${blogId}/`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Token ${authToken}`,
                'Content-Type': 'application/json',
...
const deletePaper = (paperId) => {
    ...
    if (confirm('Are you sure you want to delete this paper?')) {
        fetch(`https://hstu-six.vercel.app/api/papers/${paperId}/`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Token ${authToken}`,
                'Content-Type': 'application/json',
